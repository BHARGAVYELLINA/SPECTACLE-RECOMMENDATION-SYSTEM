...
model = tf.keras.models.load_model('faceshape_model_final.h5')
...
while True:
    ...
    print(predictions)
    # classIndex = model.predict_on_batch(img)
    ...
    for rect in rects:
        ...
        # add glasses
        if classIndex == 0:
            glass = cv2.imread("Resources/glass1.png", cv2.IMREAD_UNCHANGED)
            print("Heart")
